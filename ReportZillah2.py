...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\zillah\zillah_2014\Zillah2015.gdb\ZillahUGA_022516'
    ...
    reportFile = os.path.join(baseFileLocation, "ZillahReport_022516.txt")
    print reportFile
    value_field = 'ACRES'
