...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\zillah\zillah_2014\Zillah2015.gdb\ZillahProposed_042016'
    ...
    reportFile = os.path.join(baseFileLocation, "ZillahProposedReport_042016.txt")
    print reportFile
    value_field = 'ACRES'
