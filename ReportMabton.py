...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\mabton\Analysis2015\MabtonWorking.gdb\MabtonUGA_091115'
    baseFileLocation = r'R:\disk_5\projects\county\planning\uga_analysis\mabton\Analysis2015'
    fileGeoLocation = r'R:\disk_5\projects\county\planning\uga_analysis\mabton\Analysis2015\MabtonWorking.gdb'
    reportFile = os.path.join(baseFileLocation, "MabtonReport_091115b.txt")
    print reportFile
    value_field = 'ACRES'
    ...
    f = open(reportFile, 'w')
    line = 'Mabton Report - UGA Analysis'
    f.write(line + '\n' + '\n')
