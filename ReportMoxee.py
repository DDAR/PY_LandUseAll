...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\moxee\Analysis_2015\MoxeeAnalysis2015.gdb\MoxeeOrigUGA_033116'
    baseFileLocation = r'R:\disk_5\projects\county\planning\uga_analysis\moxee\Analysis_2015'
    fileGeoLocation = r'R:\disk_5\projects\county\planning\uga_analysis\moxee\Analysis_2015\MoxeeOrigUGA_033116.gdb'
    reportFile = os.path.join(baseFileLocation, "MoxeeCurrentReport_033116.txt")
    print reportFile
    value_field = 'ACRES'
    ...
    f = open(reportFile, 'w')
    line = 'Moxee Report - UGA Analysis'
    f.write(line + '\n' + '\n')
