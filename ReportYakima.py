...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\yakima\Analysis_2015\AnalysisLayers.gdb\Yak_Parc012016'
    #SummaryLayer = r'D:\Data\disk_5\projects\county\planning\uga_analysis\yakima\Analysis_2015\AnalysisLayers.gdb\Yak_Parc012016'
    baseFileLocation = r'R:\disk_5\projects\county\planning\uga_analysis\yakima\Analysis_2015'
    #baseFileLocation = r'D:\Data\disk_5\projects\county\planning\uga_analysis\yakima\Analysis_2015'
    fileGeoLocation = r'R:\disk_5\projects\county\planning\uga_analysis\yakima\Analysis_2015\AnalysisLayers.gdb'
    #fileGeoLocation = r'D:\Data\disk_5\projects\county\planning\uga_analysis\yakima\Analysis_2015\AnalysisLayers.gdb'
    reportFile = os.path.join(baseFileLocation, "YakimaReport_012016.txt")
    print reportFile
    value_field = 'ACRES'
    ...
    f = open(reportFile, 'w')
    line = 'Yakima Report - UGA Analysis'
    f.write(line + '\n' + '\n')
    ...
    f.write(line)
    #Total Public\Community City
    whereClause = '"ZoneGroup" = ' + "'PDEV'" + "AND" + '"CITY" = ' + '1'
    totalResVacCity = findTotals(SummaryLayer, value_vacant, whereClause)
    totalResOccCity = findTotals(SummaryLayer, value_occupied, whereClause)
    totalResCity = totalResOccCity + totalResVacCity
    line = "Total Planned Development: " + str("%.2f" % totalResCity) + '\n'
    f.write(line)
    #Total Public\Community UGA
    whereClause = '"ZoneGroup" = ' + "'PDEV'" + "AND" + '"CITY" = ' + '0'
    totalResOccUGA = findTotals(SummaryLayer, value_occupied, whereClause)
    totalResVacUGA = findTotals(SummaryLayer, value_vacant, whereClause)
    totalResUGA = totalResOccUGA + totalResVacUGA
    ...
    total = findTotals(SummaryLayer, value_field, whereClause)
    line = 'Total Environmentally Constrained: ' + str("%.2f" % total) + '\n'
    f.write(line)
    f.close()