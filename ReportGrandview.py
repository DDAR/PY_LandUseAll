...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\grandview\Analysis2015\AnalysisLayers.gdb\GrandviewUGA_091115REAL'
    baseFileLocation = r'R:\disk_5\projects\county\planning\uga_analysis\grandview\Analysis2015'
    fileGeoLocation = r'R:\disk_5\projects\county\planning\uga_analysis\grandview\Analysis2015\AnalysisLayers.gdb'
    reportFile = os.path.join(baseFileLocation, "GrandviewReport_091115.txt")
    print reportFile
    value_field = 'ACRES'
    ...
    f = open(reportFile, 'w')
    line = 'Grandview Report - UGA Analysis'
    f.write(line + '\n' + '\n')
