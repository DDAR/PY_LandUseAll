...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\naches\Analysis_2015\AnalysisData2015.gdb\NachesUGA082015'
    baseFileLocation = r'R:\disk_5\projects\county\planning\uga_analysis\naches\Analysis_2015'
    fileGeoLocation = r'R:\disk_5\projects\county\planning\uga_analysis\naches\Analysis_2015\AnalysisData2015.gdb'
    reportFile = os.path.join(baseFileLocation, "NachesReport_082015a.txt")
    print reportFile
    value_field = 'ACRES'
    ...
    f = open(reportFile, 'w')
    line = 'Naches Report - UGA Analysis'
    f.write(line + '\n' + '\n')
