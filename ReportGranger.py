...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\granger\Analysis_2015\AnalysisData.gdb\GrangerUGA_091715'
    baseFileLocation = r'R:\disk_5\projects\county\planning\uga_analysis\granger\Analysis_2015'
    fileGeoLocation = r'R:\disk_5\projects\county\planning\uga_analysis\granger\Analysis_2015\AnalysisData.gdb'
    reportFile = os.path.join(baseFileLocation, "GrangerReport_091715.txt")
    print reportFile
    value_field = 'ACRES'
    ...
    f = open(reportFile, 'w')
    line = 'Granger Report - UGA Analysis'
    f.write(line + '\n' + '\n')
