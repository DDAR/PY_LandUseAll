...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\tieton\Analysis2015\TietonUGA_Data.gdb\TietonStaffProUGA_042016'
    ...
    reportFile = os.path.join(baseFileLocation, "TietonExistingReport_042016.txt")
    print reportFile
    value_field = 'ACRES'
