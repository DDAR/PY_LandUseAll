...
if __name__ == '__main__':
    ...
    SummaryLayer = r'R:\disk_5\projects\county\planning\uga_analysis\tieton\Analysis2015\TietonUGA_Data.gdb\existing_Tieton_032116'
    ...
    reportFile = os.path.join(baseFileLocation, "TietonExistingReport_032116.txt")
    print reportFile
    value_field = 'ACRES'
